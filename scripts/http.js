...
export class WebexHttpError extends Error {
  /**
...
class Http {
  ...
  /**
   * @deprecated Use getPaginated() or getJson() instead.
   */
  async get(urlPath, params = {}, onProgress = null, onComplete = null) {
    if (typeof onProgress === "function" || typeof onComplete === "function") {
      return this.getPaginated(urlPath, params, { onProgress, onComplete });
    }

    return this.getJson(urlPath, params);
  }
